      ...
      <div className="p-6 space-y-6">
        ...
        <Collapsible open={openSections.methods}>
          ...
          <CollapsibleContent>
            <div className="space-y-4">
              <div>
                <Label htmlFor="within-estimator">Within-subgroup estimator</Label>
                <Select
                ...
                >
                  ...
                  <SelectContent>
                    <SelectItem value="rbar">R̄/d₂ (Range)</SelectItem>
                    <SelectItem value="sbar">S̄/c₄ (Std Dev)</SelectItem>
                    <SelectItem value="pooled">Pooled s</SelectItem>
                    <SelectItem value="mr">MR/d₂ (Moving Range)</SelectItem>
                  </SelectContent>
                </Select>
              </div>
