...
import { BasisType } from "./BasisSelector";
import { StabilityBanner } from "./StabilityBanner";

type SummaryTabProps = {
  config: CapabilityConfig;
  analysisBasis?: BasisType;
};
...
export function SummaryTab({ config, analysisBasis = "both" }: SummaryTabProps) {
  ...
  // Filter KPI cards based on analysis basis
  const showShortTerm = analysisBasis === "short-term" || analysisBasis === "both";
  const showLongTerm = analysisBasis === "long-term" || analysisBasis === "both";

  return (
    <div className="space-y-6">
      {/* Stability check banner */}
      <StabilityBanner isStable={false} violationCount={2} allowCompute={true} />
