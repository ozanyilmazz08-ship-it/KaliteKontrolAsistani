            ...
            <PopoverContent className="w-80" align="end">
              <div className="space-y-3">
                ...
                <div className="space-y-2">
                  ...
                  <Button variant="outline" size="sm" className="w-full justify-start">
                    <Download className="h-4 w-4 mr-2" />
                    JSON Config (reproducibility)
                  </Button>
                </div>
                <p className="text-xs text-slate-600">
                  JSON export includes specs, estimators, outlier rules, and fit settings for reproducible analysis.
                </p>
              </div>
            </PopoverContent>
          </Popover>
                ...
                <div className="space-y-3 max-h-96 overflow-y-auto">
                  <div className="p-2 bg-slate-50 rounded text-xs">
                    <div className="flex justify-between mb-1">
                      <span className="font-medium">Specs updated</span>
                      <span className="text-slate-600">2024-11-05 14:23</span>
                    </div>
                    <p className="text-slate-600">John Doe (Quality Engineer)</p>
                    <p className="mt-1">USL: 105.0 → 106.0 mm</p>
                  </div>
                  <div className="p-2 bg-slate-50 rounded text-xs">
                    <div className="flex justify-between mb-1">
                      <span className="font-medium">Estimator changed</span>
                      <span className="text-slate-600">2024-11-05 10:15</span>
                    </div>
                    <p className="text-slate-600">Jane Smith (Statistician)</p>
                    <p className="mt-1">Within estimator: S̄/c₄ → R̄/d₂</p>
                  </div>
                  <div className="p-2 bg-slate-50 rounded text-xs">
                    <div className="flex justify-between mb-1">
                      <span className="font-medium">Capability computed</span>
                      <span className="text-slate-600">2024-11-04 16:45</span>
                    </div>
                    <p className="text-slate-600">John Doe (Quality Engineer)</p>
                    <p className="mt-1">Analysis v18 • N=150 • Phase: All data</p>
                  </div>
                </div>
