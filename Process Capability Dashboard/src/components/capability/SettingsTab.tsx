          ...
          <Popover>
            ...
            <PopoverContent className="w-96" align="start">
              <div className="space-y-3">
                <h4 className="font-medium">Outlier Preview</h4>
                <div className="p-3 bg-amber-50 rounded border border-amber-200">
                  <p className="text-sm text-amber-900 mb-1">
                    <strong>{config.outliers.method === 'none' ? '0' : '3'} points</strong> would be excluded
                  </p>
                  {config.outliers.method !== 'none' && (
                    <div className="text-xs text-amber-700 space-y-1 mt-2">
                      <p>Sample #47: 108.5 mm (above threshold)</p>
                      <p>Sample #92: 91.2 mm (below threshold)</p>
                      <p>Sample #134: 109.1 mm (above threshold)</p>
                    </div>
                  )}
                </div>
                {config.outliers.method !== 'none' && (
                  <>
                    <Alert className="border-red-200 bg-red-50">
                      <AlertDescription className="text-xs text-red-900">
                        <strong>Caution:</strong> Outlier removal requires justification and SOP compliance. 
                        Never default to removing outliers without proper investigation and documentation.
                      </AlertDescription>
                    </Alert>
                    <p className="text-xs text-slate-600">
                      All excluded points will be logged to Audit History with timestamp and user information.
                    </p>
                  </>
                )}
              </div>
