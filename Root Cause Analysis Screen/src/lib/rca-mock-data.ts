  ...
  categories: [
    {
      ...
      evidenceRefs: [],
      children: [
        { id: 'p1', category: 'people', text: 'Inadequate training', evidenceRefs: ['ev-5'], severityTag: 'high', owner: 'HR Manager' },
        { id: 'p2', category: 'people', text: 'High turnover rate', evidenceRefs: ['ev-6'], severityTag: 'medium' }
      ]
    },
    {
      id: 'cat-machine',
      ...
      evidenceRefs: [],
      children: [
        { id: 'm1', category: 'machine', text: 'Equipment wear and tear', evidenceRefs: ['ev-7'], severityTag: 'critical', owner: 'Maintenance Lead' },
        { id: 'm2', category: 'machine', text: 'Calibration drift', evidenceRefs: ['ev-8'], severityTag: 'high' }
      ]
    },
    {
      id: 'cat-method',
      ...
      evidenceRefs: [],
      children: [
        { id: 'mt1', category: 'method', text: 'Process documentation outdated', evidenceRefs: [], severityTag: 'medium' },
        { id: 'mt2', category: 'method', text: 'Quality checks insufficient', evidenceRefs: ['ev-9'], severityTag: 'high', owner: 'QA Manager' }
      ]
    },
    {
      id: 'cat-material',
      ...
      evidenceRefs: [],
      children: [
        { id: 'mat1', category: 'material', text: 'Raw material variability', evidenceRefs: ['ev-10'], severityTag: 'medium' },
        { id: 'mat2', category: 'material', text: 'Supplier quality issues', evidenceRefs: ['ev-11'], severityTag: 'high', owner: 'Procurement' }
      ]
    },
    {
      id: 'cat-measurement',
      ...
      evidenceRefs: [],
      children: [
        { id: 'ms1', category: 'measurement', text: 'Inspection tools accuracy', evidenceRefs: ['ev-12'], severityTag: 'medium' }
      ]
    },
    {
      id: 'cat-environment',
      ...
      evidenceRefs: [],
      children: [
        { id: 'e1', category: 'environment', text: 'Temperature fluctuations', evidenceRefs: ['ev-13'], severityTag: 'low' }
      ]
    }
  ]
};
