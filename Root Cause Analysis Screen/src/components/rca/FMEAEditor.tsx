...
import { Plus, Search, Filter, Settings2, Download, Upload, ChevronRight, ChevronLeft, AlertTriangle, Info, Trash2, MoreHorizontal, X, TrendingUp, Clock, CheckCircle2, Circle, AlertCircle } from 'lucide-react';
    ...
    <div className="h-full flex bg-slate-50/50">
      ...
      <div className="flex-1 flex flex-col overflow-hidden bg-white">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="flex-1 flex flex-col overflow-hidden">
          ...
          {/* Risk Matrix View */}
          <TabsContent value="matrix" className="flex-1 overflow-hidden m-0 p-6">
